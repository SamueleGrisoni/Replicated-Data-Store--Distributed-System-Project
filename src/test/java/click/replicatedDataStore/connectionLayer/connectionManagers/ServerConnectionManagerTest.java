...
public class ServerConnectionManagerTest {
    ...
    Map<Integer, Pair<String, ServerPorts>> portsIpIndexes = new HashMap<>();
    ...
    public void setUp() {
        ...
        portsIpIndexes.put(0, new Pair<>(ip, new ServerPorts(port0, 8080)));
        portsIpIndexes.put(1, new Pair<>(ip, new ServerPorts(port1, 8080)));
    ...
    private void initializeServer(int index, Server server, Map<Integer, Pair<String, ServerPorts>> serverIpPortMap){
    ...
    private void initialize3(){
        nServer = 3;
        portsIpIndexes.put(2, new Pair<>(ip, new ServerPorts(port2, 8080)));
